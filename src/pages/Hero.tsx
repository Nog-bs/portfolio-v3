...
export const Hero: React.FC = () => {
    ...
    return (
        <Layout>
            <TopHeader>Hi, my name is Edro "edge-row" Gonzales and I am a <a href="https://en.wikipedia.org/wiki/Software_engineering" target="_blank" ref="noreferrer"><Text as="span" color="teal" _hover={{ textDecoration: 'underline'}}>Software Engineer</Text></a></TopHeader>
